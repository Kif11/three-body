...
const App = () => (
  <a-scene
    ...
    sunSystem="speed: 0.02; skyRadius: 500; timeOffset:5000000; color: #ffe4aa;"
    renderer="
      antialias: true;
  ...
  >
    ...
    <a-entity id="scene2">
      ...
      <a-gltf-model id="pyramid" src="#pyramid" gltf-model="assets/pyramid/pyramid.gltf" rotation="0 -85.67151431693634" position="60.74943 -0.04867 65.32669" scale="" set-gltf-material="color: #e2aa73; receiveShadow: true"></a-gltf-model>
